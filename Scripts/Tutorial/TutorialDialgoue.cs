...
public class TutorialDialgoue : MonoBehaviour
{
	...
	public void conversationStart(string _name, TextAsset _dialogue, Color _npcColour, tomNPC _npc, Sprite image)
	{
		whichNPC = _npc;
		speaking = true;
		npcName = _name;
